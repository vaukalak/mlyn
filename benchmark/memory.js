...
/*
const a$ = new Subject({ id: 0 });
const id$ = a$.id;
const b$ = new Subject({ id: 0 });
const c$ = new Subject({ id: 0 });
/*/
const a$ = createSubject({ id: 0 });
const b$ = createSubject({ id: 0 });
const c$ = createSubject({ id: 0 });
const id$ = a$.id;
//*/
...
// setTimeout(() => {
// }, 10000);
console.log(getMem() - startMem - 1720);
